...
2.  (UW) conduct a literature review evaluating the temperature requirements of aquatic species to evaluate the significance of potential changes to the stream thermal regime
...
3.  (UW) identify potential ecosystem co-benefits that could arise from innovative pumped-storage hydropower operations
