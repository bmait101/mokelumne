...
plot_flow_duration(df, water_year_start = 10, ignore_missing = TRUE)
plot_flow_duration(df, water_year_start = 10, ignore_missing = TRUE, end_year = 1980)
plot_flow_duration(df, water_year_start = 10, ignore_missing = TRUE, start_year = 1990)


plot_daily_stats(df, water_year_start = 10, ignore_missing = TRUE)
plot_daily_stats(df, water_year_start = 10, ignore_missing = TRUE, end_year = 1980)
plot_daily_stats(df, water_year_start = 10, ignore_missing = TRUE, start_year = 1990)
