...
China (200 GW), Canada (89 GW), and Brazil (70 GW) are leaders in total hydro generation. Other notable producers include Russia, India, Norway, Japan, and Venezuela (which is almost completely dependent on hydropower).
...
Minimizing and mitigating environmental impacts of hydropower is a key challenge
...
### The Duck Curve: integrating solar and wind

Solar and wind generation require quick generation ramp up/down resulting in a graph of power production over the course of a day that shows the timing imbalance between peak demand and solar power generation (the duck curve). The term was coined in 2012 by the California Independent System Operator.
